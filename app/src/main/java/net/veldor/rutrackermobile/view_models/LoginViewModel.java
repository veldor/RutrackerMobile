...
import net.veldor.rutrackermobile.workers.LoginWorker;

import static net.veldor.rutrackermobile.workers.LoginWorker.LOGIN_ACTION;
import static net.veldor.rutrackermobile.workers.LoginWorker.USER_LOGIN;
import static net.veldor.rutrackermobile.workers.LoginWorker.USER_PASSWORD;
